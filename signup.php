...
<body>
    <main class="main">
        <section class="container-signup">
            <form action="includes/signup.inc.php" method="post" id="signup" class="signup">
                <h2>Sign Up</h2>
                <?php signup_inputs(); ?> <!-- name, lastname, email inputs -->
                <input type="password" name="pwd" class="pwd" placeholder="password">
                <h3>birthday</h3>
                <div class="select_birthday" name="birthday">
                ...
                <div class="gender" name="gender">
                    <div class="femalegen">
                        <input type="radio" id="genderfemale" name="genderoption" value="female">
                        <label for="genderfemale">female</label>
                    </div>
                    <div class="malegen">
                        <input type="radio" id="gendermale" name="genderoption"  value="male">
            ...
            <?php //check_signup_errors(); ?> <!-- alert the errors, remove the comment if you want to see it, here and signup_view.php -->
        </section>
    </main>
</body>
</html>